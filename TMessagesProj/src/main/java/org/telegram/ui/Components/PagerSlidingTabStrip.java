...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private void addIconTab(final int position, Drawable drawable, CharSequence contentDescription) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            RippleDrawable rippleDrawable = (RippleDrawable) Theme.createSelectorDrawable(getThemedColor(Theme.key_chat_messagePanelIcons), Theme.RIPPLE_MASK_CIRCLE_20DP, AndroidUtilities.dp(18));
